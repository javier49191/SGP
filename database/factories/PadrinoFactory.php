...
$factory->define(Padrino::class, function (Faker $faker) {
    ...
    return [
    	...
    	'telefono' => $faker->numberBetween($min = 35100000, $max = 35100000),
    	'segundo_telefono' => $faker->numberBetween($min = 35100000, $max = 35100000),
        ...
        'checklist' => $faker->numberBetween($min = 0, $max = 1),
    ];
});
